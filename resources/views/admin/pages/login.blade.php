	...
	<div class="container-fluid-full">
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					<div class="icons">
						<a href="{{route('trang-chu')}}"><i class="halflings-icon home"></i></a>
					</div>
					<h2>Login Form</h2>
					...
					<input type="hidden" name="_token" value="{!! csrf_token() !!}">
						<fieldset>
							<div class="input-prepend" title="Email">
								...
								<input class="input-large span10" name="email" id="email" type="email" placeholder="Email" value="{{old('username')}}" />
							</div>
