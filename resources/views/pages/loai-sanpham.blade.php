								...
								<div class="col-sm-4" style="padding-bottom: 30px">
									<div class="single-item" style="height: 350px">
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary pull-right" href="{{route('sanpham',$loai->id)}}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
								</div>
								@endforeach
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="single-item" style="height: 350px">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary pull-right" href="{{route('sanpham',$spk->id)}}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								@endforeach
