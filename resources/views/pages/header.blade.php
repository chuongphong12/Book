<div id="header">
		...
		<div class="container">
			<div class="pull-left auto-width-left">
				<ul class="top-menu menu-beta l-inline">
					<li><a href="{{route('contact')}}"><i class="fa fa-home"></i> 142 Phạm Phú Thứ, Phường 3, Quận 6</a>
					</li>
			...
			<div class="pull-right auto-width-right">
				<ul class="top-details menu-beta l-inline">
					...
					<li><a href="{{route('admin.users.getList')}}"><i class="fa fa-user"></i>Welcome
							{{Auth::user()->full_name}}</a></li>
					@else
					<li><a href="{{route('edit',Auth::user()->id)}}"><i class="fa fa-user"></i>Welcome
							{{Auth::user()->full_name}}</a></li>
					@endif
	...
	<div class="header-body">
		<div class="container beta-relative">
			<div class="pull-left">
				<a href="{{route('trang-chu')}}" id="logo"><img src="sources/assets/dest/images/logo-book.png"
						width="200px" alt=""></a>
			</div>
				...
				<div class="beta-comp">
					...
					<div class="cart">
						...
						<div class="beta-dropdown cart-body">
							...
							<div class="cart-item">
								<a class="cart-item-delete" href="{{route('deletecart',$product['item']['id'])}}"><i
										class="fa fa-times"></i></a>
								<div class="media">
									<a class="pull-left" href="#"><img
											src="sources/image/product/{{$product['item']['image']}}" alt=""></a>
									<div class="media-body">
										...
										<span class="cart-item-amount">{{$product['qty']}} * <span>
												...
												đ @else {{number_format($product['item']['promotion_price'])}} đ
												@endif</span></span>
									</div>
								</div>
							</div>
							...
							<div class="cart-caption">
								<div class="cart-total text-right">Total: <span
										...
										@else 0 @endif đ</span></div>
								<div class="clearfix"></div>

								<div class="center">
									<div class="space10">&nbsp;</div>
									@if(Auth::check())
									<a href="{{route('dathang')}}" class="beta-btn primary text-center">Order <i
											class="fa fa-chevron-right"></i></a>
									@else
									<a data-toggle="modal" data-target="#login"
										class="beta-btn primary text-center">Order <i
											class="fa fa-chevron-right"></i></a>
									@endif
								</div>
							</div>
